...
def transform_got10k(tracker_name, cfg_name):
    ...
    # make zip archive
    shutil.make_archive(src_dir, "zip", root_dir=os.path.dirname(src_dir), base_dir="got10k")
    shutil.make_archive(dest_dir, "zip", root_dir=os.path.dirname(dest_dir), base_dir="got10k_submit")
